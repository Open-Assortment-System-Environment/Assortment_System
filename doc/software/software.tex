...
\begin{figure}
	\includegraphics[width=0.98\textheight,angle =90]{db-model_parts_A}
	\centering
	\caption{The design of the parts schema A}
\end{figure}

\begin{figure}
\includegraphics[height=\columnwidth,angle =90]{db-model_parts_B}
\centering
...
\begin{figure}
	\includegraphics[height=\columnwidth,angle =90]{db-model_storage_A}
	\centering
	\caption{The design of the storage schema A}
\end{figure}

\begin{figure}
\includegraphics[height=\columnwidth,angle =90]{db-model_storage_B}
\centering
