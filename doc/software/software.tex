...
\begin{figure}[h]
	\includegraphics[width=0.65\columnwidth]{db-model_global}
	\centering
...
\begin{figure}[h]
	\includegraphics[width=0.65\columnwidth]{db-model_assemblies}
	\centering
...
\begin{figure}[h]
	\includegraphics[width=0.8\columnwidth]{db-model_kicad}
	\centering
	\caption{The design of the storage schema}
\end{figure}
